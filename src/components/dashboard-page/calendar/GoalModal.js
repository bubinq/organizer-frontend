      ...
      <div className={styles.eventModal}>
        <div className={styles.modalHeader}>
          <div className={styles.popUpWrapper}>
            ...
            <h3>
              Go to my goal's page:
              <Link
                key={dayInfo._id}
                to={`/goals/${dayInfo._id}`}
                className={styles.links}
                onClick={closeUpdatingHandler}
              >
                {dayInfo.goal}
              </Link>
            </h3>
            <h3>Update Existing One</h3>
            <button className={styles.updateBtn} onClick={showUpdateHandler}>
              Update
            </button>
            <h3 className={styles.h3Spec}>Or</h3>
            <button className={styles.deleteBtn} onClick={showDeleteHandler}>
              Delete
            </button>
          </div>
        </div>
